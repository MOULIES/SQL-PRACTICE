...
-- in case there are less than 3 employees in a department then return employees with next
-- lowest salary in that department


DROP DATABASE IF EXISTS SQL33;

CREATE DATABASE IF NOT EXISTS SQL33;
